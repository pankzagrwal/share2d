                ...
                >
                  ...
                  <Grid item xs={12}>
                    <TextField
                      ...
                      value={storeAddress}
                      onChange={(evt) => {
                        setStoreAddress(evt.target.value);
                      }}
                    />
                  </Grid>
                  <Grid item xs={12}>
                    <Grid container alignItems="center" justify="space-between">
                      ...
                      <Grid item>
                        <Button
                          size="small"
                          href={`https://www.google.com/maps/search/?api=1&query=${geoPosition?.latitude},${geoPosition?.longitude}`}
                          color="secondary"
                          target="_blank"
                  ...
                  <Grid item xs={12}>
                    <TextField
                      ...
                      value={industryId}
                      onChange={(evt) => {
                        setIndustryId(evt.target.value);
                      }}
